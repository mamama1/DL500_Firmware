	...
	#define UART_SEND_INTERVAL				1000
	
	// #define BUTTON_REPEAT_VALUE_INTERVAL	100

	#define DAC_LOWER_LIMIT					0
	#define DAC_UPPER_LIMIT					500 // (Vout (max) in mV - VOUT_OFFSET_MV) / VOUT_GAIN

	#define DAC_VREF						2500
	#define DAC_VREF_HALF					1250
	#define DAC_VREF_DOUBLE					5000

	#define DAC_BITS						16384 // 14 Bit
	#define DAC_OFFSET						0
	#define DAC_MIN_SET_DELAY				50
	#define DAC_GAIN						1.0

	// #define VOLTAGE_UPPER_LIMIT				25000	// mV
	// #define VOLTAGE_LOWER_LIMIT				0		// mV
	#define CURRENT_UPPER_LIMIT				500			// mA
	#define CURRENT_LOWER_LIMIT				0			// mA

	#define DAC_STARTUP_VALUE				DAC_LOWER_LIMIT
	...
	#define ADC_INPUT_VOLTAGE_DIVIDER		1
